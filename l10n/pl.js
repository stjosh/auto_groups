OC.L10N.register(
    "auto_groups",
    {
    "Group \"%1$s\" is used in the Auto Groups App and cannot be deleted." : "Grupa \"%1$s\" jest używana w aplikacji Auto Groups i nie można jej usunąć.",
    ...
    "Check Auto Group membership on user modification." : "Sprawdź członkostwo w Grupie automatycznej podczas modyfikacji użytkownika.",
    "If checked, Auto Group membership will be re-enforced on every user modification." : "Jeśli zaznaczone, członkostwo w Grupie automatycznej będzie ponownie wymuszane przy każdej modyfikacji użytkownika.",
