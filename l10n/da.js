OC.L10N.register(
    ...
    "Set Auto Group membership on user creation." : "Indstil Auto Group-medlemskab ved brugeroprettelse.",
    "If checked, Auto Group membership will be enforced on user creation." : "Hvis dette er markeret, vil Auto Group-medlemskab blive håndhævet ved oprettelse af bruger.",
    "Check Auto Group membership on user modification." : "Tjek Auto Group-medlemskab ved brugerændring.",
    "If checked, Auto Group membership will be re-enforced on every user modification." : "Hvis det er markeret, vil Auto Group-medlemskab blive genhævet ved hver brugerændring.",
