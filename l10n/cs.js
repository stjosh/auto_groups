OC.L10N.register(
    ...
    "Set Auto Group membership on user creation." : "Při vytváření uživatele nastavit automatické členství ve skupinách.",
    "If checked, Auto Group membership will be enforced on user creation." : "Pokud je zaškrtnuto, automatické členství ve skupinách bude vynucováno při vytváření uživatele.",
    "Check Auto Group membership on user modification." : "Při úpravách uživatele kontrolovat automatické členství ve skupinách.",
    "If checked, Auto Group membership will be re-enforced on every user modification." : "Pokud je zaškrtnuto, automatické členství ve skupinách bude znovu vynucováno při všech úpravách uživatelského účtu.",
