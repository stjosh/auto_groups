OC.L10N.register(
    ...
    "Set Auto Group membership on user creation." : "Imposta l'appartenenza ai gruppi automatici in fase di creazione degli utenti.",
    "If checked, Auto Group membership will be enforced on user creation." : "Se selezionata, l'appartenenza al gruppo automatico sarà forzata in fase di creazione dell'utente.",
    "Check Auto Group membership on modification of a user's groups." : "Controllare l'appartenenza automatica al gruppo quando si modificano i gruppi di un utente.",
    "If checked, Auto Group membership will be re-enforced for a user account every time it is added to or removed from a group." : "Se selezionata, l'appartenenza automatica al gruppo verrà ripristinata per un account utente ogni volta che questo viene aggiunto o rimosso da un gruppo.",
