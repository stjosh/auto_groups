OC.L10N.register(
    "auto_groups",
    {
    "Group \"%1$s\" is used in the Auto Groups App and cannot be deleted." : "Le groupe \"%1$s\" est utilisé pour l'application de groupes automatiques et ne peut pas être supprimé.",
    ...
    "Check Auto Group membership on user modification." : "Vérifier l’adhésion automatique au groupe lors de la modification de l’utilisateur.",
    "If checked, Auto Group membership will be re-enforced on every user modification." : "Si coché, l'adhésion automatique au groupe sera réappliquée à chaque modification du compte utilisateur.",
