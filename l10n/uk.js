OC.L10N.register(
    ...
    "Check Auto Group membership on user modification." : "Перевірте членство в автоматичній групі під час зміни користувача.",
    "If checked, Auto Group membership will be re-enforced on every user modification." : "Якщо позначено, автоматичне членство в групі буде відновлено після кожної зміни користувача.",
    "Check for correct Auto Group membership on every login." : "Перевіряти правильність членства у автоматичних групах щоразу при вході.",
